function [prewittCikisDegeri] = PrewittFonksiyon(inimage, filtreBoyutu)
    %Filtre boyutu
    ...
    %boyutlandýrýyoruz.
    prewittCikisDegeri=double(zeros(row-filtreBoyutu-1,col-filtreBoyutu-1));    
    ...
    for y=boyut2:row-boyut2
        for x=boyut2:col-boyut2
            ...
            prewittCikisDegeri(y-boyut1,x-boyut1)=sqrt(deger);
        end
    end
    
    %Çýktý resminin veri tipinin integer a dönüþtürülmesi
    prewittCikisDegeri=uint8(prewittCikisDegeri);
